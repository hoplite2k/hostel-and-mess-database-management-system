...
const Editstudent = (props) => {
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updatestudentdetails({
            _id: studentid, name, usn, image, branch, year, roomno, roomatename, roomateusn, dob, idproof, contact, email, address, feespaid, feesdue, penalties, firstyear, finalyear, bloodgrp, parents: { fname, mname, paddress, pemail, pcontact },
        }));
    }
